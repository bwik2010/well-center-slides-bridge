...
const BridgeTeam = () => {
  const teamMembers = [
    { name: "Trish Weaver", title: "Attorney", position: { x: 130, y: 150 } },
    { name: "Pamela Roussos", title: "CEO Weaving Impact", position: { x: 400, y: 80 } },
    { name: "KC Whang", title: "Commercial Real Estate", position: { x: 550, y: 140 } },
    { name: "Omar Palos", title: "Business Owner: Sweet Seasons", position: { x: 500, y: 460 } },
    { name: "Jay Gerson", title: "Business Owner: Kidsco", position: { x: 220, y: 500 } },
    { name: "Bruce Baker", title: "Non-Profit Executive", position: { x: 360, y: 520 } },
    { name: "Mayrin Munguia", title: "Chick Fil A Franchise Owner", position: { x: 100, y: 460 } },
    { name: "David Son", title: "Pastor and Business Owner", position: { x: 60, y: 340 } },
    { name: "Jasmine Dero", title: "Teacher, Business Owner", position: { x: 80, y: 200 } },
    { name: "Robin McKinney", title: "Non-Profit Executive", position: { x: 240, y: 120 } },
    { name: "Gloria Kalotra", title: "Higher Education Specialist", position: { x: 480, y: 80 } },
    { name: "Rajesh Prabhu", title: "Entrepreneur", position: { x: 500, y: 370 } }
  ];
