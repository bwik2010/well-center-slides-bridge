  ...
  return <div className="w-full h-full p-6" style={{
    aspectRatio: '16/9'
      ...
      <div className="text-center mb-6">
        ...
        color: '#173e4e'
      }}>Community Impact by the Numbers</h2>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          return <div key={index} className="bg-white rounded-2xl p-4 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 text-center">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          background: 'linear-gradient(135deg, #173e4e 0%, #8aa1a9 100%)'
            ...
            <h3 className="text-lg font-bold mb-3">Social Enterprise</h3>
            <div className="text-center">
              <div className="text-2xl font-bold mb-2" style={{
              color: '#b8832b'
            }}>Entrepreneurial Eco-System</div>
              <p className="text-sm opacity-90">Offering mentoring, shared business services and co-working space</p>
            </div>
          </div>
          
          <div className="rounded-2xl p-6" style={{
          backgroundColor: '#8aa1a920',
          border: '2px solid #8aa1a9'
        }}>
