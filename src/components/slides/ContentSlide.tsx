  ...
  return (
    <div className="h-full p-8">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-gray-800 mb-8 text-center">Content Slide Template</h2>
        
        <div className="grid md:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <h3 className="text-2xl font-semibold text-gray-800 mb-6">Key Points & Benefits</h3>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-emerald-100 to-teal-100 rounded-2xl p-8 h-80 flex items-center justify-center">
              <div className="text-center">
                <div className="w-32 h-32 bg-emerald-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                  <span className="text-4xl font-bold text-white">W</span>
                </div>
                <h4 className="text-xl font-semibold text-gray-800 mb-2">Visual Content Area</h4>
                <p className="text-gray-600">Charts, images, or infographics can be placed here</p>
              </div>
            </div>
            
            {/* Decorative elements */}
            <div className="absolute -top-4 -right-4 w-8 h-8 bg-teal-400 rounded-full opacity-60"></div>
