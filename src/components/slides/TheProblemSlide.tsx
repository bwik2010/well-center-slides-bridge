...
const TheProblemSlide = () => {
  const keyStatistics = [{
    ...
    icon: Users,
    stat: <span className="flex items-center gap-1">
          75% <ArrowDown className="h-4 w-4" style={{
        color: "#dc2626"
      }} /> vs 88% <ArrowUp className="h-4 w-4" style={{
        color: "#16a34a"
      }} />
        </span>,
  ...
  return <div className="w-full h-full p-3 flex flex-col" style={{
    aspectRatio: '16/9'
  }}>
      {/* Header Section */}
      ...
      <div className="flex-1 grid grid-cols-12 gap-3">
        ...
        <div className="col-span-4 flex flex-col justify-between h-full">
          ...
          return <div key={index} className="bg-white rounded-xl p-4 shadow-lg border-l-4 hover:shadow-xl transition-all duration-300 flex-1 flex items-center" style={{
            ...
            minHeight: '120px'
                ...
                backgroundColor: item.color + '20'
                    ...
                    <IconComponent className="h-7 w-7" style={{
                  color: item.color
                }} />
                  </div>
                  ...
                  color: item.color
                    ...
                    <div className="text-sm text-gray-600 leading-tight">
                      {item.label}
                      <sup className="ml-1 text-xs font-semibold" style={{
                    color: item.color
                  }}>
                        {item.footnote}
                      </sup>
        ...
        <div className="col-span-8">
          <div className="h-full rounded-xl p-5 text-white shadow-lg flex flex-col justify-center" style={{
