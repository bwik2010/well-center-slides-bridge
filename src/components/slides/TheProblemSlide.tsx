    ...
    aspectRatio: '16/9'
      ...
      <div className="flex-1 flex gap-3 min-h-0">
        ...
        <div className="w-64 flex flex-col gap-2">
          ...
          return <div key={index} className="bg-white rounded-xl p-3 shadow-lg border border-gray-100 text-center hover:shadow-xl transition-all duration-300">
                <div className="w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-1" style={{
