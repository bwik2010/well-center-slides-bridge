...
const BridgeTeamSlide = () => {
  const teamMembers = [
    ...
    { name: "Pamela Roussos", position: { x: 300, y: 110 } },
    { name: "KC Whang", position: { x: 400, y: 220 } },
    { name: "Omar Palos", position: { x: 360, y: 330 } },
    { name: "Jay Gerson", position: { x: 240, y: 370 } },
    { name: "Larry Bram", position: { x: 120, y: 330 } },
    { name: "Mayrin Munguia", position: { x: 80, y: 220 } },
    { name: "Lucia Zegara", position: { x: 120, y: 110 } },
    { name: "David Son", position: { x: 480, y: 150 } },
    { name: "Jasmine Dero", position: { x: 440, y: 300 } },
    { name: "Robin McKinney", position: { x: 40, y: 300 } },
    { name: "Gloria Kalotra", position: { x: 280, y: 40 } }
  ];

  const centerPosition = { x: 240, y: 205 };
  ...
  return (
    <div className="w-full h-full flex flex-col" style={{ background: 'linear-gradient(135deg, #8aa1a920 0%, #173e4e20 100%)' }}>
      {/* Header */}
      <div className="flex items-center justify-center pt-8 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold" style={{ color: '#173e4e' }}>Well Center Bridge Team</h1>
            <p className="text-lg text-gray-600">Team Network Visualization</p>
          </div>
        </div>
      </div>
